...
/**
 * Description: 抓取江苏省连云港市 信息
 * @author nzq
 * @date 2017年9月9日 上午9:02:43
 * @version V1.0
 */

public class GrabJsLyg extends GrabTidyTableUtils {
	private Log logger = LogFactory.getLog(GrabJsLyg.class);
	 ...
	 */
 	public List<Map<String, Object>> grabListKjj(List<Map<String, Object>> listParam) {
		...
		logger.info("抓取连云港市  科技局 信息列表数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(list)+"】");
	 ...
	 */
 	public List<Map<String, Object>> grabListJxw(List<Map<String, Object>> listParam) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取江苏省连云港市  经信委 信息列表数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(list)+"】");
	 ...
	 */
 	public List<Map<String, Object>> grabListSwj(List<Map<String, Object>> listParam) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取江苏省连云港市 商务局 信息列表数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(list)+"】");
	 ...
	 */
 	public List<Map<String, Object>> grabListFgw(List<Map<String, Object>> listParam) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取江苏省连云港市 发改委 信息列表数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(list)+"】");
	...
	private Map<String, Object> grabKjjInfo(String url, Map<String, Object> model) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取 江苏省连云港市 科技局详情数据 数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(model)+"】");
		return model;
	}
	...
	private Map<String, Object> grabJxwInfo(String url, Map<String, Object> model) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取 江苏省连云港市 经信委详情数据 数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(model)+"】");
		return model;
	}
	...
	private Map<String, Object> grabSwjInfo(String url, Map<String, Object> model) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取 江苏省连云港市 商务局详情数据 数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(model)+"】");
		return model;
	}
	...
	private Map<String, Object> grabFgwInfo(String url, Map<String, Object> model) {
		...
		long end = System.currentTimeMillis();
		logger.info("抓取 江苏省连云港市发改委详情数据 数据耗时："+(end-start)+"ms(毫秒), 数据结果【"+JsonUtils.toJson(model)+"】");
		return model;
	}
	
	public static void main(String[] args) {
		List<Map<String, Object>> list = new LinkedList<Map<String, Object>>();
		GrabJsLyg grabJsNj = new GrabJsLyg();
