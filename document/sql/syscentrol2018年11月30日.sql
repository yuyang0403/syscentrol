...
insert  into `sys_menu`(`id`,`parent_id`,`name`,`title`,`component`,`path`,`icon`,`order_index`,`description`,`status`,`created_time`,`update_time`,`created_by`,`update_by`,`remark`) values (1,0,'system','系统管理',NULL,'index',NULL,NULL,'系统管理',1,'2018-06-19 12:26:06',NULL,'test',NULL,NULL),(2,1,'user','用户管理',NULL,'index','icon-user',NULL,'用户管理',1,'2018-06-19 12:27:30',NULL,NULL,NULL,NULL),(3,1,'role','角色管理',NULL,'index','icon-role',NULL,'角色管理',1,'2018-06-19 12:27:56',NULL,NULL,NULL,NULL),(4,1,'menu','菜单管理',NULL,'index','icon-menu',NULL,'菜单管理',1,'2018-06-19 12:28:19',NULL,NULL,NULL,NULL),(5,0,NULL,NULL,'@/views/layout/Layout','/icon',NULL,NULL,'图标',1,NULL,NULL,NULL,NULL,NULL),(6,5,'Icons','icons','@/views/svg-icons/index','index','icon',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(7,0,'Example','example','@/views/layout/Layout','/example','example',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(8,7,'CreateArticle','createArticle','@/views/example/create','create','edit',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(10,7,'ArticleList','articleList','@/views/example/list','list','list',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(11,0,NULL,NULL,'@/views/layout/Layout','/tab',NULL,NULL,'tab页',1,NULL,NULL,NULL,NULL,NULL),(12,11,'Tab','tab','@/views/tab/index','index','tab',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL);
...
insert  into `sys_role_menu`(`role_id`,`menu_id`) values (1,5),(1,6),(1,7),(1,8),(1,10),(1,11),(1,12);
